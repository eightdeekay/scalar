 ...
 *
 * Generated at: 2026-09-18T20:18:45.052Z
 */
...
/** A named link to display alongside the API info */
export type XScalarLinkItem = {
...
export type XScalarLinks = {
  /** Additional named links to display alongside the API info (e.g. privacy policy, imprint) */
  'x-scalar-links'?: XScalarLinkItem[]
}
...
export type XBadge = {
  ...
  color?: string
  /** The color of the badge text, in the same formats as color. Derived from color when omitted. */
  textColor?: string
}
...
export type WebhooksObject = Record<
  string,
  | PathItemObject
  | (ReferenceObject & {
      '$ref-value': PathItemObject
...
export type ComponentsPathItems = Record<
  string,
  | PathItemObject
  | (ReferenceObject & {
      '$ref-value': PathItemObject
